...
| 界面 | 状态 |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.7-alpha.2`（2026-09-18 验证；dev 与运行时钉 `0.1.7-alpha.2`，peer 为 `>=0.1.2-rc.1 <0.2.0 \|\| >=0.1.5-alpha.1 <0.2.0 \|\| >=0.1.6-0 <0.2.0 \|\| >=0.1.7-0 <0.2.0`） |
| Node | `^22.19.0 \|\| >=24.0.0` |
