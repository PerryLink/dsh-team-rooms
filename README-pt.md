...
[![dshfind](https://dshfind.com/api/badge/PerryLink/dsh-team-rooms?metric=downloads&lang=pt)](https://dshfind.com/pt/plugins/PerryLink/dsh-team-rooms?ref=badge)
...
| Superfície | Estado |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.7-alpha.1` (verificado em 2026-09-18; dev e runtime fixam `0.1.7-alpha.2`, peers `>=0.1.2-rc.1 <0.2.0 \|\| >=0.1.5-alpha.1 <0.2.0 \|\| >=0.1.6-0 <0.2.0 \|\| >=0.1.7-0 <0.2.0`) |
| Node | `^22.19.0 \|\| >=24.0.0` |
